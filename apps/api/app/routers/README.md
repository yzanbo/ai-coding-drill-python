...
- 業務ロジック（計算・分岐・認可）は書かない。書くのは services 側
- DB クエリも書かない。SQLAlchemy 操作は [repositories/](../repositories/) に集約され、services が呼び出す（→ [ADR 0044](../../../../docs/adr/0044-backend-repository-pattern-adoption.md)）
