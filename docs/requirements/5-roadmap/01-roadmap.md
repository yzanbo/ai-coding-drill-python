...
| R0-3 | モノレポ枠（pnpm workspaces + Turborepo + `packages/config`）| 🔴 次タスク | 後続ツールの設定置き場 → [ADR 0012](../../adr/0012-turborepo-pnpm-monorepo.md) |
...
| ID | 項目 | 状態 | 関連 |
|---|---|---|---|
| R1-1 | ジョブペイロード JSON Schema 確定 + TS/Go 型自動生成（shared-types パターン確立）| 🔴 | [ADR 0014](../../adr/0014-json-schema-as-single-source-of-truth.md) |
