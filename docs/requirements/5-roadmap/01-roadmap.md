...
旧「Phase X」表記との対応は [ADR 0019](../../adr/0019-requirements-as-5-buckets.md) 参照（Phase 0〜9 = R0〜R9）。各 ADR は判断更新時に本文を直接書き換える運用なので、リリース表記の整理が必要になった ADR は順次「Phase X」→「RX」に更新してよい。
