...
| R0-4 | Biome + lefthook の pre-commit 接続 | 🔴 次タスク | コード蓄積前にフォーマット規律 → [ADR 0013](../../adr/0013-biome-for-tooling.md) |
| R0-5 | GitHub Actions（min：commitlint + Biome + typecheck）| 🔴 | リモートで規約逸脱を弾く |
...
| R1-6 | 採点ワーカー（Go）初版 + サンドボックス（Docker + 制限フラグ）| 🔴 | [ADR 0005](../../adr/0005-go-for-grading-worker.md) / [ADR 0008](../../adr/0008-disposable-sandbox-container.md) |
