...
| 認証時 | GitHub アカウントだけでログインしたい — 別アカウント登録の手間を省きたいから | [GitHub OAuth ログイン](../4-features/authentication.md) |
...
| 認証時 | 解答を送ると即座に採点結果が返ってきてほしい — 手動レビューを待たず学習効率を最大化したいから | [自動採点](../4-features/grading.md) |
| 認証時 | 過去の解答履歴と弱点カテゴリを確認したい — 進捗と苦手分野を客観的に把握したいから | [学習履歴](../4-features/learning.md) |
