...
- [ADR 0024: syncpack による package.json 整合性](./0024-syncpack-package-json-consistency.md)（Accepted, Amended by 0033 / 0036、Frontend 用途として継続採用、本 ADR で Python 側は uv lockfile に集約）
