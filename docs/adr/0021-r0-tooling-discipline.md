...
- Biome / TypeScript / mise / pnpm（→ [ADR 0036](./0036-frontend-monorepo-pnpm-only.md) / [ADR 0039](./0039-mise-for-task-runner-and-tool-versions.md)）側で同等機能が標準提供された場合（重複排除を検討）
