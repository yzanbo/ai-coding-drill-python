...
- DB は PostgreSQL 16 で確定（→ [07_tech_stack.md: データベース](../requirements/base/07_tech_stack.md#データベース)）
...
- **Repository レイヤ不要**：Drizzle 自体が Repository 風の API を提供するため、Service が直接呼び出す方針（→ [ADR 0004](./0004-nestjs-for-backend.md)、[04_architecture.md: Backend API](../requirements/base/04_architecture.md#backend-apinestjs)）と整合
...
- [07_tech_stack.md: データベース](../requirements/base/07_tech_stack.md#データベース)
