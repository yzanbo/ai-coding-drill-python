...
- [ADR 0004](./0004-postgres-as-job-queue.md) — Redis 不使用と対をなす「Postgres ジョブキュー採用」の決定
- [ADR 0047](./0047-session-store-on-redis.md) — Redis の 3 用途のうち**セッション用途**を積極採用する根拠（本 ADR が「Redis をジョブキューに使わない」禁止判断、ADR 0047 が「Redis をセッションに使う」積極判断）
