...
- **Repository レイヤ不要**：Drizzle 自体が Repository 風の API を提供するため、Service が直接呼び出す方針（→ [ADR 0014](./0014-nestjs-for-backend.md)、[02-architecture.md: Backend API](../requirements/2-foundation/02-architecture.md#backend-apinestjs)）と整合
