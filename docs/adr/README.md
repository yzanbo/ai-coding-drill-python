...
| [0049](./0049-initial-llm-model-selection.md) | MVP の初期 LLM プロバイダは Gemini 単独（`gemini-3-flash` を全ロールに割当）、R2 ベンチマークで別ベンダー Judge に切替予定 | ポートフォリオ用途 / 無料枠優先 / 抽象化レイヤで切替容易 / ADR 0008 例外運用 |
